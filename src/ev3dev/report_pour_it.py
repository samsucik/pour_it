# pour_it's own version of the report module that 
# uses pre-programmed percept providers instead of
# getting percepts from command line. 
# 
# This is just a tweaked version of report_en.py
# originally shipped within Timon Reinold's 
# ev3py-runlocal package.
# 
# As we work with more and more sensors/motors/etc,
# the methods here will be rewritten to reflect our
# need for connecting percept emmitters to this module.
